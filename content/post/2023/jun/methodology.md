...
While modyfying our concent we faced several challenges as well. The date, even though displayed correctly on preview on GitHub, was shown with inappropriate year. Next, while adding pictures, we realised that our changes take time to be displayed correctly after the deployment. Lastly, we followed the GitHub instructions about adding pictures, but sometimes they we not displayed.
