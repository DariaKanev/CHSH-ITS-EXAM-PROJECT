...
While modyfying our content we faced several challenges as well. The date, even though displayed correctly on preview on GitHub, was shown with inappropriate year. When we tried ti embed graphic elements from our data stories, we noticed that some are still not displayed on the website and others are not seen even on preview. Lastly, the pictures to be added needed to be addres through the link even though we added the, to the corresponding folder in our repository.
